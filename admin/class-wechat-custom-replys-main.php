    ...
    function wechat_custom_replys_page_handler()
    {
        ...
        <div class="wrap">
            ...
            <form id="persons-table" method="GET">
                ...
                <?php
                $table->search_box(__('search', $this->plugin_slug), 'custom_reply_search');
                $table->display(); ?>
            </form>
...
<!--                    <input id="reply_content" name="reply_content" type="text" style="width: 95%" value="<?php /*echo esc_attr($item['reply_content'])*/?>"
                    ...
                    <textarea name="reply_content" type="text" id="reply_content"
                              cols="50" rows="6" value="<?php echo esc_attr($item['reply_content'])?>" required><?php echo esc_attr($item['reply_content'])?></textarea>
                </td>
            </tr>
            <tr class="form-field">
                <th valign="top" scope="row">
